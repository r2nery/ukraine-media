...
class URLFetcher:
    ...
    def fetch(self):
        with alive_bar(self.num_pages, title="-> Scraper", spinner="dots_waves", bar="smooth", force_tty=True) as bar:
...
class articleFetcher:
    ...
    def fetch(self):
        with alive_bar(len(self.unique_urls), title="-> Scraper", spinner="dots_waves", bar="smooth", force_tty=True) as bar:
